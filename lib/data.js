...
const { last, kebabCase, uniq, isEmpty } = require('lodash')

const getProjects = async () => {
  const slugger = new GHSlugger()
  const csv = await fetch(
    'https://docs.google.com/spreadsheets/d/e/2PACX-1vT09aaljVDEDqpI4XYFCFzadBwQNilIxsfAaxdKPy6O3_5bQAMAhrbzdCuotDplTGixlZe9EiKedIGS/pub?gid=774749386&single=true&output=csv'
  ).then(r => r.text())
